...
def main(mot_file: str, video_path: str, csv_name: str,
         skip_video: bool, width: int, height: int) -> None:
    ...
    all_data = []
    for frame_n in df["frame"].unique():
...
if __name__ == "__main__":
    ...
    parser.add_argument('-w', '--width', help='Video width', type=int)
    parser.add_argument('-a', '--height', help='Video height', type=int)
    ...
    main(args.filename, args.video, args.name, args.skip_video, args.width, args.height)
